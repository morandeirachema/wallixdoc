...
Continue to [05 - Authentication](../05-authentication/README.md) for an overview of all authentication methods, or see [34 - JIT Access](../34-jit-access/README.md) for just-in-time access workflows that can integrate with Kerberos SSO.
