...
|----------|-------------|
| [Authentication](../05-authentication/README.md) | Authentication methods and MFA configuration |
| [Authorization](../06-authorization/README.md) | RBAC and approval workflows |
| [Password Management](../07-password-management/README.md) | Credential vault and rotation |
| [Session Management](../08-session-management/README.md) | Session recording and monitoring |
| [FIDO2 Hardware MFA](../52-fido2-hardware-mfa/README.md) | Hardware token configuration |
| [JIT Access](../34-jit-access/README.md) | Just-in-time access workflows |
...
Continue to [Authorization](../06-authorization/README.md) for detailed RBAC configuration and approval workflow setup.
