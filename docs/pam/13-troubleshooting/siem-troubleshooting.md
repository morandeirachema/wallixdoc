...
echo "CEF:0|WALLIX|WALLIX Bastion|12.1.x|100|Test|1|msg=test" | nc -w1 localhost 514
```
...
# CEF:0|WALLIX|WALLIX Bastion|12.1.x|100|User Login|5|src=10.10.1.50...
```
...
```
CEF:0|WALLIX|WALLIX Bastion|12.1.x|<event_id>|<event_name>|<severity>|<extensions>

Example events:
CEF:0|WALLIX|WALLIX Bastion|12.1.x|100|User Login Success|3|src=10.10.1.100 suser=jadmin outcome=success
CEF:0|WALLIX|WALLIX Bastion|12.1.x|101|User Login Failed|7|src=10.10.1.100 suser=baduser outcome=failure reason=invalid_password
CEF:0|WALLIX|WALLIX Bastion|12.1.x|200|Session Started|3|src=10.10.1.100 suser=jadmin dhost=linux-test duser=root proto=SSH
```
